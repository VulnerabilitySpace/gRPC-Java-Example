...
public class ServerCallListener<REQUEST> extends ForwardingServerCallListener.SimpleForwardingServerCallListener<REQUEST> {
    protected ServerCallListener(ServerCall.Listener<REQUEST> delegate) {
        super(delegate);
    }

    @Override
    public void onMessage(REQUEST message) {
        // todo: 获取请求体，解析请求体的数据，存入污点池，进行后续的污点传播
